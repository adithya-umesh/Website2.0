...
const socialLinks = [
  { 
    ...
    color: 'text-pink-500',
    hoverColor: 'md:text-gray-400 md:hover:text-pink-500',
    icon: (
  ...
  { 
    name: 'LinkedIn', 
    href: 'https://www.linkedin.com/company/team-vegavath-racing/',
    color: 'text-blue-500',
    hoverColor: 'md:text-gray-400 md:hover:text-blue-500',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
  ...
  { 
    ...
    hoverColor: 'md:text-gray-400 md:hover:text-purple-400',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <div className="flex flex-wrap gap-3 mb-6">
                {socialLinks.map((social) => (
                  <a
                    ...
                    className={`w-10 h-10 bg-gray-800/50 rounded-lg flex items-center justify-center ${social.color} ${social.hoverColor} transition-all duration-300 hover:scale-110 hover:bg-gray-700/50 hover:shadow-lg`}
                  >
                    {social.icon}
                  </a>
                ))}
