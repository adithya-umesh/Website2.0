...
const navItems = [
  ...
  { name: 'EmbedX 2.0', href: '/embedx-2', highlight: true },
]
            ...
            <div className="hidden md:flex items-center space-x-8">
              {navItems.map((item) => (
                <Link
                  key={item.name}
                  href={item.href}
                  className={`relative transition-colors duration-200 modern-body transform hover:scale-105 ${
                    (item as any).highlight 
                      ? 'text-white bg-gradient-orange px-4 py-2 rounded-lg font-semibold hover:shadow-lg hover:shadow-orange-500/25' 
                ...
                <div key={item.name} className="transition-transform duration-150">
                  <Link
                    ...
                    className={`block px-4 py-2 rounded-lg transition-all duration-200 ${
                      (item as any).highlight
                        ? 'text-white bg-gradient-orange font-semibold text-center'
