...
export default function Legal() {
  return (
    <>
      <SiteMaintenanceClient page="legal" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="mt-16 text-center pb-12">
          <Link href="/">
            <button className="px-8 py-4 bg-gradient-orange text-white font-semibold rounded-lg hover:scale-105 transition-transform duration-300 hover:shadow-lg hover:shadow-orange-500/25">
              Back to Home
            </button>
          </Link>
        </div>
